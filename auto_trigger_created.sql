...
mysql> DELIMITER $
mysql> CREATE TRIGGER UPD_CURR_ATTD AFTER INSERT ON ATTENDANCE_RECORDS FOR EACH ROW BEGIN  UPDATE STUDENT_ENROLLMENT,ATTENDANCE_RECORDS  SET STUDENT_ENROLLMENT.CURRENT_ATTENDANCE=STUDENT_ENROLLMENT.CURRENT_ATTENDANCE +1 WHERE STUDENT_ENROLLMENT.STUDENT_ID=ATTENDANCE_RECORDS.STUDENT_ID AND ATTENDANCE_RECORDS.STATUS="P";  UPDATE STUDENT_ENROLLMENT,ATTENDANCE_RECORDS SET STUDENT_ENROLLMENT.LAST_UPDATED_ATTD=NOW() WHERE STUDENT_ENROLLMENT.STUDENT_ID=ATTENDANCE_RECORDS.STUDENT_ID AND ATTENDANCE_RECORDS.STATUS="P"; END$
